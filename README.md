...
```
cd existing_repo
git remote add origin https://gitlab.cern.ch/bldelane/ddmisid.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.cern.ch/bldelane/ddmisid/-/settings/integrations)
